...
def rewrite_kimi_argv(argv: list[str], *, config_file: str | None) -> list[str]:
...
def prepare_config_file(argv: list[str], *, environ: dict[str, str] | None = None) -> str | None:
    ...
    if api_key:
        return str(write_kimi_openrouter_config(api_key, model, share_dir=Path(share)))
...
def main(argv: list[str] | None = None) -> int:
    ...
    rewritten = rewrite_kimi_argv(args, config_file=config_file)
